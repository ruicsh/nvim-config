...
loadColorSet({
	...
	["@markup.link.markdown"] = { fg = c.nord3_700 },
...
loadColorSet({
	...
	DiagnosticFloatingError = { link = "LspDiagnosticsDefaultError" },
	DiagnosticFloatingHint = { link = "LspDiagnosticsDefaultHint" },
	DiagnosticFloatingInfo = { link = "LspDiagnosticsDefaultInformation" },
	DiagnosticFloatingWarn = { link = "LspDiagnosticsDefaultWarning" },
	...
	DiagnosticVirtualTextWarn = { link = "LspDiagnosticsDefaultWarning" },
